...
RFLAGS= -g -c -D$(TO_OS) -DREB_API  $(RAPI_FLAGS) $I
HFLAGS= -g -c -D$(TO_OS) -DREB_CORE $(HOST_FLAGS) $I
CLIB= -lm
...
# Directly linked r3 debug executable:
r3debug$(BIN_SUFFIX):	objs $(OBJS) $(HOST)
	$(CC) -o r3$(BIN_SUFFIX) $(OBJS) $(HOST) $(CLIB)
	$(LS) r3$(BIN_SUFFIX)
